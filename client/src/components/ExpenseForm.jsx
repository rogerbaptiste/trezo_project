...
<button className=" " onClick={(e) => navigateToEditExpense(item._id)}><box-icon color ={'gray'} name="wrench"/></button>
                ...
                {/* <button className="btn btn-danger" onClick={deleteExpense}>Delete Store</button> */}
            ...
            {/* <form action="" onSubmit={handleSubmit}>
                <div className='grid gap-4'>
                    <input type="text" {...expense && expense.name} placeholder='Gas Bill, House Rent'onChange={onChangeHandler} value = {expense.name} />
